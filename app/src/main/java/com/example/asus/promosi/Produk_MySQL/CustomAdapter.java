...
public class CustomAdapter extends BaseAdapter {
    ...
    public CustomAdapter(Context c, ArrayList<Ukiran> produk) {
        this.c = c;
        this.produk = produk;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView detail = (ImageView) convertView.findViewById(R.id.imageProduct);
        TextView judul_product = (TextView) convertView.findViewById(R.id.txtJudulProduct);
        TextView keterangan = (TextView) convertView.findViewById(R.id.txtKeterangan);
